...
internal class TLSSocketFactory : SSLSocketFactory() {
  ...
  @Throws(IOException::class) override fun createSocket(): Socket {
    return enableTLSOnSocket(internalSSLSocketFactory.createSocket())
  }

  @Throws(IOException::class) override fun createSocket(
    s: Socket,
    host: String,
    port: Int,
    autoClose: Boolean
  ...
  @Throws(
      IOException::class, UnknownHostException::class
