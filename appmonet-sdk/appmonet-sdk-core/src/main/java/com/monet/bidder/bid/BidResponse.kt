...
data class BidResponse(
    ...
    data class Interstitial(val format: String, val close: Boolean, val trusted: Boolean) {
        object Mapper {
...
//                    sLogger.warn("json missing bid code: defaulting")
                ...
                if (interstitialJSON != null) {
                    interstitial = Interstitial(interstitialJSON.getString(INTERSTITIAL_FORMAT_KEY),
        ...
        fun toJson(bid: BidResponse?): JSONObject {
            ...
            bid?.let {
                try {
                    ...
                    json.putOpt(CODE_KEY, if (bid.code.isNotEmpty()) bid.code else Constants.Dfp.DEFAULT_BIDDER_KEY)
