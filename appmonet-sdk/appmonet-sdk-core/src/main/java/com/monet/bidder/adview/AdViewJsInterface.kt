...
internal class AdViewJsInterface(
  ...
  @JavascriptInterface fun markClick(isClicked: Boolean) {
    adViewManagerCallback.wasAdViewClicked = isClicked
  }
  ...
  @JavascriptInterface fun hasPermission(permission: String?): String {
    return java.lang.Boolean.toString(adViewManagerCallback.hasPermission(permission!!))
  }
  ...
  @get:JavascriptInterface val visibleActivityCount: String
    get() = RenderingUtils.numVisibleActivities().toString()
  ...
  @get:JavascriptInterface val isScreenOn: String
    get() = java.lang.Boolean.toString(adViewManagerCallback.isScreenOn())
